...
%11th question
    ...
    \item 
%12th question
    {For every pair of continuous functions $f, g: \sbrak{0, 1}\mapsto R$ such that max $\{f\brak{x}: x\in \sbrak{0, 1}\}$= max $\{g\brak{x}: x\in \sbrak{0, 1}\}$, the correct statement\brak{s} is\brak{are}:}
