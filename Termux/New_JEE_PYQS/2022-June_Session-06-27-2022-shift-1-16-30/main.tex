...
\begin{enumerate}
    ...
    \begin{align*}
        adj\brak{adj\brak{A}} = \myvec{14 & 28 & -14 \\ -14 & 14 & 28 \\ 28 & -14 & 14},
    \end{align*}
    is \rule{1cm}{0.1pt}
    ...
    \begin{align*}
        \brak{\frac{\sqrt{x}}{5^{\frac{1}{4}}} + \frac{\sqrt{5}}{x^{\frac{1}{3}}}}
    \end{align*}
    ...
    \end{align*}
    if $27\brak{Area A_1} = 5\brak{Area A_2}$, then $k$ is equal to: \rule{1cm}{0.1pt}
