...
%9th question
    ...
    \item 
%10th question
	    For $a\in R$ \brak{\text{the set of all real numbers}}, $a\neq -1$ 
    \begin{align*}
...
%13th question    
		...
		\frac{x}{\abs{x}}g\brak{x}, & x\neq 0 \\
            0, & x=0
        \end{cases}$ 
	and $h\brak{x}=e^{\abs{x}}$ for all $x\in R$. Let $\brak{f\circ h}\brak{x}$ denote $f\brak{h\brak{x}})$ and $\brak{h\circ f}\brak{x}$ denote $h\brak{f\brak{x}}$. Then which of the following is\brak{are} true? 
